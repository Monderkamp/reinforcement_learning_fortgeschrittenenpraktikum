...
print(p)
print(learner.D, D_calc)

ax.plot(X,p[0]*X+p[1],linestyle="dashed",label="fit")
ax.legend()
ax.set_xlabel(r"$t$")
ax.set_ylabel(r"$\left <x^2(t) \right >$")
#plt.savefig('C:/Users/Edgar Hartmann/Documents/6. Semester WS 21_22/FP/Reinforcement learing/Aufgabe_1_MSD/Grafiken/Aufgabe_1_MSD_%f_%f_HARTMANN_%s.png' %(learner.D, D_calc, now))
plt.show()
