...
#-------------------------------------------------------------------
#JEDER VOR DIESEM KOMMENTAR
#HIER WIRD DIE TRAJEKTORIE ALS GIF AUSGEGEBEN.
#FALLS DIES BEI IHNEN ZU LANGE DAUERT, ODER DIE LIBRARY NICHT VORHANDEN IST, 
#BEENDEN SIE DAS SKRIPT VOR DIESEM COMMAND MIT exit()		
#-------------------------------------------------------------------		
